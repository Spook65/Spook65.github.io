...
function buildHospitalCityScene(scene, data) {
  ...
  addPlane(scene, { x: 7.2, y: 0.34 }, { x: 0, y: -0.025, z: 0.85 }, { x: -Math.PI / 2, y: 0, z: 0.05 }, roadMaterial);
  addPlane(scene, { x: 0.36, y: 4.4 }, { x: -1.25, y: -0.02, z: -0.05 }, { x: -Math.PI / 2, y: 0, z: 0.1 }, roadMaterial);
  ...
  addBox(scene, { x: 1.75, y: 1.25, z: 0.76 }, { x: 0.65, y: 0.58, z: -1.32 }, hospitalMaterial);
  addBox(scene, { x: 0.58, y: 1.82, z: 0.58 }, { x: 1.62, y: 0.88, z: -1.2 }, hospitalMaterial);
  ...
  const core = addBox(scene, { x: 0.42, y: 1.68, z: 0.42 }, { x: 1.68, y: 1.05, z: -0.62 }, coreMaterial);
  core.name = "hospital-network-core";
  ...
  addBox(scene, { x: 0.78, y: 0.46, z: 0.42 }, { x: -1.75, y: 0.22, z: 0.55 }, propMaterial);
  addBox(scene, { x: 0.88, y: 0.28, z: 0.34 }, { x: 0.9, y: 0.12, z: 1.15 }, propMaterial);
  addBox(scene, { x: 0.52, y: 0.68, z: 0.44 }, { x: -0.55, y: 0.32, z: -0.8 }, propMaterial);
